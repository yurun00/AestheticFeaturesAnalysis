...
for i = 1:length(paintings)
    if(exist([addr_feature, 'features_genre\', paintings{i} , '_color_tw.mat'],'file'))
        load([addr_feature, 'features_genre\', paintings{i} , '_color_tw.mat']);
    ...
    save([addr_feature, 'features_genre\', paintings{i} , '_color_tw.mat'], 'gbcolor', 'lccolor');
    disp(i);
end
